...
```javascript
import gaxpy from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-gaxpy@v0.0.8-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/blas-base-gaxpy/actions/workflows/test.yml/badge.svg?branch=v0.0.8
[test-url]: https://github.com/stdlib-js/blas-base-gaxpy/actions/workflows/test.yml?query=branch:v0.0.8
